            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    @auth
                        ...
                        @else
                            <a href="{{ route('admin.page_management') }}">
                                <x-application-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" />
                            </a>
                        @endif
                    @else
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        ...
                        @else
                            <x-nav-link :href="route('admin.page_management')" :active="request()->routeIs('admin.page_management')">
                                {{ __('Quản lý trang') }}
                            </x-nav-link>
                        @endif
                    @endauth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @else
                    <x-responsive-nav-link :href="route('admin.page_management')" :active="request()->routeIs('admin.page_management')">
                        {{ __('Quản lý trang') }}
                    </x-responsive-nav-link>
                @endif
            @endauth
